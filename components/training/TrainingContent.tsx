  ...
  return (
    <>
        ...
        <div className="container-x grid gap-8 py-12 md:grid-cols-12 md:py-16">
          <div className="md:col-span-7">
            ...
            <div className="mt-5 flex flex-wrap gap-4 text-[11px] uppercase tracking-widest text-primary-foreground/85">
              ...
              <span className="inline-flex items-center gap-2">
                <Video className="size-4 text-accent" /> Online & self-paced
              </span>
              <span className="inline-flex items-center gap-2">
                <Users className="size-4 text-accent" /> Small-group live workshops
              </span>
              <span className="inline-flex items-center gap-2">
                <GraduationCap className="size-4 text-accent" /> Certificate of completion
              </span>
            </div>
          </div>
          <div className="md:col-span-5">
            <div className="overflow-hidden rounded-2xl border border-accent/30">
              ...
              <img
                ...
                alt="Medical practitioners in a hands-on training workshop"
                width={1280}
                height={896}
                loading="lazy"
      ...
      {status === "ok" && (
        <div className="border-b border-accent/30 bg-accent/10">
          <div className="container-x py-4 text-sm text-primary">
            Thank you — your training enrollment request was received. We&apos;ll send dates, payment
            instructions and onboarding details shortly.
          </div>
        </div>
      )}
            ...
            <div className="md:col-span-4">
              <div className="sticky top-24">
                ...
                <p className="mt-3 text-sm text-muted-foreground">
                  {track === "Icoone" &&
                    "Non-invasive Roboderm® micro-stimulation for face, body, lymphatic and post-surgical recovery."}
                  {track === "Exosomes" &&
                    "Exosome and AAPE protocols for skin rejuvenation, hair restoration and combination aesthetic treatments."}
                  {track === "Peptides" &&
                    "Clinical use of GLP-1s, recovery and longevity peptides — sourcing, dosing, compliance and patient management."}
                  {track === "Nutrition" &&
                    "General nutrition education designed to integrate into a clinical or wellness practice, plus practical guidance on how to eat when taking GLP-1\u2019s and peptides to obtain and maintain healthy habits. Led by a certified nutritionist."}
                </p>
                {track === "Nutrition" && (
                  <div className="mt-5 overflow-hidden rounded-sm border border-primary/10">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img
                      src="/images/food-nutrition.jpg"
                      alt="Healthy meal with fresh vegetables and lean protein"
                      width={1024}
                      height={768}
                      loading="lazy"
                      className="h-56 w-full bg-background object-cover"
                    />
                    <div className="bg-card px-4 py-3 text-xs text-muted-foreground">
                      <span className="font-semibold text-primary">Nutrition Training</span> · Led by a certified
                      nutritionist
                    </div>
                  </div>
                )}
              ...
              {courses
                ...
                .map((c) => {
                  ...
                  return (
                    <label
                      key={c.id}
                      className={`block cursor-pointer rounded-sm border p-5 transition ${
                        checked
                          ? "border-accent bg-accent/5"
                          : "border-primary/10 bg-card hover:border-accent/40"
                      }`}
                    >
                          ...
                          <div className="flex flex-wrap items-start justify-between gap-3">
                            <div className="min-w-0">
                              ...
                              <div className="mt-1 flex flex-wrap gap-2 text-[10px] uppercase tracking-widest">
                                ...
                                <span className="rounded-full border border-primary/15 px-2 py-0.5 text-primary/70">
                                  {c.hours}
                                </span>
                              </div>
                            </div>
      ...
      <section id="signup" className="border-b border-primary/10 bg-primary/5">
        <div className="container-x grid gap-10 py-16 md:grid-cols-12 md:py-20">
          <div className="md:col-span-5">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Select your courses above, complete the form, and our education team will confirm dates and
              payment. Live workshops are held in small groups — early signup is recommended.
            </p>
          ...
          >
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <label className="block md:col-span-2">
                ...
                {errs.experience && (
                  <span className="mt-1 block text-xs text-destructive">{errs.experience}</span>
                )}
              </label>
              ...
              <div className="md:col-span-2">
                <label className="inline-flex items-start gap-2 text-xs text-primary/80">
                  ...
                  <span>
                    I understand training is fee-based, registration is confirmed only after payment, and refund
                    / reschedule terms will be shared with my confirmation.
                  </span>
                </label>
      ...
      <p className="container-x py-8 text-center text-xs text-muted-foreground">
        Training is intended for licensed medical and aesthetic professionals. Completion certificates document
        attendance and content covered; CE credit varies by jurisdiction.
      </p>
    </>
  );
}
