...
export function FaqContent({
  ...
  const faqCategories = categories.length > 0 ? categories : DEFAULT_FAQ_CATEGORIES;
            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="rounded-sm border border-primary/10 bg-primary/5 p-5">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Our support team is available Mon–Fri, 8am–7pm ET. Clinical support is available 24/7 for
                  active accounts.
                </p>
                    ...
                    return (
                      <div key={itemId} className="py-5">
                        ...
                        >
                          ...
                          <span
                            className={`mt-1 shrink-0 text-lg text-accent transition-transform ${isOpen ? "rotate-45" : ""}`}
                          >
                            +
                          </span>
                        </button>
