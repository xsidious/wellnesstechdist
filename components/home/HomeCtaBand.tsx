  ...
  return (
    <section className="px-3 pb-3">
      <div className="overflow-hidden rounded-3xl bg-primary text-primary-foreground shadow-[0_24px_60px_rgba(15,40,60,0.16)]">
        <div className="container-x flex flex-col items-start gap-6 py-16 md:flex-row md:items-end md:justify-between md:py-20">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3.5 text-xs font-semibold uppercase tracking-[0.14em] text-accent-foreground shadow-[0_12px_28px_rgba(0,0,0,0.16)] transition hover:bg-gold-soft"
          >
