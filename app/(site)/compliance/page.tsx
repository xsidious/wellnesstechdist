      ...
      <section className="container-x grid gap-8 py-24 md:grid-cols-2">
        <div className="rounded-sm border border-primary/10 bg-card p-10">
          ...
          <h2 className="mt-3 font-display text-3xl font-semibold text-primary">
            Traditional Patient-Specific
          </h2>
          <p className="mt-3 text-muted-foreground">
            Requires a valid individual patient prescription. Regulated by state pharmacy boards. Must
            comply with USP &lt;795&gt;/&lt;797&gt; standards.
          </p>
        ...
        <div className="rounded-sm border border-accent/30 bg-primary p-10 text-primary-foreground">
          ...
          <p className="mt-3 text-primary-foreground/90">
            Federally registered under FDA oversight. May produce large batches for healthcare
            facilities without an individual Rx. Operates under CGMP standards.
          </p>
      ...
      <section className="bg-primary/5 py-24">
        <div className="container-x">
          ...
          <h2 className="mt-3 max-w-2xl font-display text-4xl font-semibold text-primary">
            How we classify every compound.
          </h2>
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              ...
              {
                tag: "Semi-Synthetic",
                desc: "Structurally modified analog of a natural compound.",
              },
              {
                tag: "Synthetic",
                desc: "Fully laboratory-synthesized; no direct natural counterpart.",
              },
            ].map((n) => (
              <div key={n.tag} className="rounded-sm border border-primary/10 bg-card p-6">
                <div className="inline-flex rounded-full bg-accent/15 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-accent">
                  {n.tag}
                </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm text-muted-foreground">
                Side effects and contraindications listed in our materials reflect the most commonly
                reported. This is not an exhaustive safety profile. Individual responses vary. Always
                conduct a full patient assessment before prescribing. Compounded medications are not
                FDA-approved for the indications listed.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                name: "Precision Peptide Therapy Catalog",
              },
              {
                file: "/docs/Compounded_Wellness_Sales_Sheet.pdf",
                name: "Compounded Wellness Protocols",
              },
              {
              ...
              >
                ...
                <span className="text-xs uppercase tracking-widest text-muted-foreground group-hover:text-accent">
                  PDF
                </span>
              </a>
            ))}
          ...
          <div className="mt-12">
            <div className="mb-6 flex items-center gap-2 text-primary/70">
              ...
              <span className="text-xs font-semibold uppercase tracking-widest">
                Catalogs & marketing materials — request access below
              </span>
            </div>
